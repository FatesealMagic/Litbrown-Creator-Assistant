...
class LCADecklistModel (pydantic.BaseModel, validate_assignment = True, extra = 'forbid'):
	url: str = ''
	updated: datetime.datetime = pydantic.Field(default_factory = datetime.datetime.now)
	title: typing.Optional[str] = None
	description: typing.Optional[str] = None
	
	class BoardsModel (pydantic.BaseModel, validate_assignment = True, extra = 'forbid'):
