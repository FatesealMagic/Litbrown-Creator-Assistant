...
class LCACTwitchWidget (LCAWidget):
	...
	def __start_oauth_flow (self) -> None:
		...
		logger.info(f'Starting Twitch oauth flow at URL {Config().integrations.remote.twitch.oauth_url}')
		webbrowser.open(Config().integrations.remote.twitch.oauth_url)
